#DROP TABLE IF EXISTS insights.airings; #content_product_brand_category_station_network_show_coop
...
DROP TRIGGER IF EXISTS airing_init;
DELIMITER //
CREATE TRIGGER airing_init BEFORE INSERT ON insights.airings FOR EACH ROW
	BEGIN
